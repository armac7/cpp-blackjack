...
class Card 
{
    public:
        ...
        {
            /**
             * @brief [Copy constructor. Copies the param to the new card.]
             * @param card [Card to be copied.]
             * @return [No return, copy constructor.]
            */
        ...
        {
            /**
             * @brief [Returns the card face.]
             * @return [Returns a string representing the card face (Card Face is "King", "Queen", etc.).]
            */
            return cardFace;
        }
        ...
        friend int operator +(int toAdd, const Card &card) 
        {
            return toAdd + card.number;
        }
        ...
        {
            bool equals = false;
            if (cardFace == rhs.cardFace && cardType == rhs.cardType) equals = true;
            return equals;
        }
    private:
